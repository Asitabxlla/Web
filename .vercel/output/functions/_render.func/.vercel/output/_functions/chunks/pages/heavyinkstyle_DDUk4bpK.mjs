...
const $$Heavyinkstyle = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Heavyinkstyle;
...
}, "F:/Asia Archivos/Pictures/Uni 2024/Web/src/pages/heavyinkstyle.astro", void 0);

const $$file = "F:/Asia Archivos/Pictures/Uni 2024/Web/src/pages/heavyinkstyle.astro";
const $$url = "/heavyinkstyle";

export { $$Heavyinkstyle as default, $$file as file, $$url as url };
