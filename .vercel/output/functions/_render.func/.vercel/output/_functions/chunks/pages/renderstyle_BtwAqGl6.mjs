...
const $$Renderstyle = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Renderstyle;
...
}, "F:/Asia Archivos/Pictures/Uni 2024/Web/src/pages/renderstyle.astro", void 0);

const $$file = "F:/Asia Archivos/Pictures/Uni 2024/Web/src/pages/renderstyle.astro";
const $$url = "/renderstyle";

export { $$Renderstyle as default, $$file as file, $$url as url };
