/* empty css                                   */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as renderSlot, f as renderHead, g as addAttribute, h as renderComponent } from '../astro_DeanQqZl.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
/* empty css                                   */
...
Lineart Style
</a> </li> <li> <a href="/heavyinkstyle" class="text-white hover:text-blue-600">
Heavy Ink Style
</a> </li> <li> <a href="/renderstyle" class="text-white hover:text-blue-600">
Render Style
</a> </li> <li> <a href="/charactersheet" class="text-white hover:text-blue-600">
Character Sheet
</a> </li> <li> <a href="/traditionalart" class="text-white hover:text-blue-600">
Traditional Art
</a> </li> </ul> </div> </div> </li> <li> <a href="/portfolio" class="block py-2 px-3 text-white border-b border-primary hover:bg-base-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0">Portfolio</a> </li> </ul> </div> </div> </nav> </header>`;
}, "F:/Asia Archivos/Pictures/Uni 2024/Web/src/components/Header.astro", void 0);
...
}, "F:/Asia Archivos/Pictures/Uni 2024/Web/src/pages/charactersheet.astro", void 0);

const $$file = "F:/Asia Archivos/Pictures/Uni 2024/Web/src/pages/charactersheet.astro";
const $$url = "/charactersheet";

const charactersheet = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
...
export { $$Header as $, $$LayoutRefs as a, charactersheet as c };
